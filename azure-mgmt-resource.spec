...
Source0  : https://files.pythonhosted.org/packages/9b/a9/4430d728c8b1db0ff2eac5b7a2b210c5ba70a7590613664e4c8e8fb10c11/azure-mgmt-resource-15.0.0.zip
...
%prep
%setup -q -n azure-mgmt-resource-15.0.0
cd %{_builddir}/azure-mgmt-resource-15.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608047604
